...
import junction.config.audit.AuditEventConverter;
import junction.domain.PersistentAuditEvent;
...
import static junction.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
