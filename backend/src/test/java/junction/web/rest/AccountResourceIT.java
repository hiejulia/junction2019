...
import junction.config.Constants;
import junction.domain.Authority;
import junction.domain.User;
import junction.repository.AuthorityRepository;
import junction.repository.UserRepository;
import junction.security.AuthoritiesConstants;
import junction.service.MailService;
import junction.service.UserService;
import junction.service.dto.PasswordChangeDTO;
import junction.service.dto.UserDTO;
import junction.web.rest.errors.ExceptionTranslator;
import junction.web.rest.vm.KeyAndPasswordVM;
import junction.web.rest.vm.ManagedUserVM;
